...
object Permissioni {
     ...
     * [Permissioni.READ_EXTERNAL_STORAGE] 和 [Permissioni.WRITE_EXTERNAL_STORAGE] 权限
     *
     *
     ...
     *
     * 1. 如果适配了分区存储的情况下：
     * 1) 如果项目 targetSdkVersion <= 32 需要申请 [Permissioni.READ_EXTERNAL_STORAGE]
     * 2) 如果项目 targetSdkVersion >= 33 需要申请 [Permissioni.READ_MEDIA_IMAGES]
     *
     *
     * 2. 如果没有适配分区存储的情况下：
     * 1) 如果项目 targetSdkVersion <= 29 需要申请 [Permissioni.READ_EXTERNAL_STORAGE]
     * 2) 如果项目 targetSdkVersion >= 30 需要申请 [Permissioni.MANAGE_EXTERNAL_STORAGE]
     */
