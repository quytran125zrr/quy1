...
public class Binaryqdsa {

    private static final String KEY_PLACEHOLDER = "_placeholder";

    private static final String KEY_NUM = "num";
    
    private static final Logger logger = Logger.getLogger(Binaryqdsa.class.getName());

    @SuppressWarnings("unchecked")
    public static DeconstructedPacket deconstructPacket(Packetqxcbd packet) {
    ...
    @SuppressWarnings("unchecked")
    public static Packetqxcbd reconstructPacket(Packetqxcbd packet, byte[][] buffers) {
