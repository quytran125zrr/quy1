package com.xxx.zzz.aall.ioppp.socketlll.hasbinarynn;
...
public class HasBinaryq {
	
    private static final Logger logger = Logger.getLogger(HasBinaryq.class.getName());
