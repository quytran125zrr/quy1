...
public final class UTF8z {
    ...
    public static String encode(String string) throws UTF8Exceptionz {
        return encode(string, new Options());
    }

    public static String encode(String string, Options opts) throws UTF8Exceptionz {
    ...
    public static String decode(String byteString) throws UTF8Exceptionz {
        return decode(byteString, new Options());
    }

    public static String decode(String byteString, Options opts) throws UTF8Exceptionz {
        boolean strict = opts.strict;
    ...
    private static String encodeCodePoint(int codePoint, boolean strict) throws UTF8Exceptionz {
    ...
    private static int decodeSymbol(boolean strict) throws UTF8Exceptionz {
        int byte1;
        int byte2;
        int byte3;
        int byte4;
        ...
        if (byteIndex > byteCount) {
            throw new UTF8Exceptionz("Invalid byte index");
        }
        ...
        if ((byte1 & 0xE0) == 0xC0) {
            ...
            if (codePoint >= 0x80) {
                ...
                throw new UTF8Exceptionz(INVALID_CONTINUATION_BYTE);
            }
        }
    ...
    private static int readContinuationByte() throws UTF8Exceptionz {
        if (byteIndex >= byteCount) {
            throw new UTF8Exceptionz("Invalid byte index");
        }
    ...
    private static boolean checkScalarValue(int codePoint, boolean strict) throws UTF8Exceptionz {
        if (codePoint >= 0xD800 && codePoint <= 0xDFFF) {
            if (strict) {
                throw new UTF8Exceptionz(
