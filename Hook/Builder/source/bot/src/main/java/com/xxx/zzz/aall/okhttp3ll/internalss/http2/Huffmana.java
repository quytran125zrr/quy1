...
class Huffmana {
  ...
  private static final Huffmana INSTANCE = new Huffmana();

  public static Huffmana get() {
    return INSTANCE;
  }
  ...
  void encode(ByteStringzaq data, BufferedSinkzaqds sink) throws IOException {
    long current = 0;
    int n = 0;
  ...
  int encodedLength(ByteStringzaq bytes) {
    long len = 0;
